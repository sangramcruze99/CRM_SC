...
export const MICROSERVICES = [
  ...
  { name: 'finance', dir: 'apps/finance', port: 3015, category: 'Ledger & Invoices', isCore: true },
  ...
  { name: 'documents', dir: 'apps/documents', port: 3020, category: 'Document Management', isCore: true },
