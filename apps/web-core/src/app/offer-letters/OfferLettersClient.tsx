...
import { Plus, Download, CheckCircle, Clock, Send, Award, User, Mail, Briefcase, Building, DollarSign, Percent, Sparkles, X, FolderOpen, Paperclip } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto text-white">
        ...
        <div className="fixed inset-0 z-[9999] bg-slate-950/80 backdrop-blur-xl flex items-center justify-center p-4 animate-in fade-in duration-200">
          <div className="relative w-full max-w-lg bg-gradient-to-b from-slate-900/95 via-slate-950/98 to-slate-950/99 border border-white/[0.14] rounded-3xl p-6 sm:p-7 shadow-[0_25px_70px_rgba(0,0,0,0.85),0_0_0_1px_rgba(16,185,129,0.15)] backdrop-blur-2xl text-white space-y-5 animate-in zoom-in-95 duration-200 overflow-hidden">
            ...
            <form onSubmit={handleCreate} className="space-y-4 text-xs relative z-10">
              ...
              {/* Document Vault Attachment (Benefits Guide, NDA, IP Agreement) */}
              <div className="space-y-1.5">
                <div className="flex items-center justify-between">
                  <label className="block text-[10px] uppercase font-black tracking-wider text-slate-400">Attached Vault Documents</label>
                  <button
                    type="button"
                ...
                {attachedVaultDoc ? (
                  ...
                  >
                    <FolderOpen size={13} />
                    <span>Attach Benefits Guide, NDA, or Policy from Document Vault</span>
                  </button>
                )}
              </div>
      ...
      <DocumentVaultPickerModal
        ...
        title="Attach Document to Offer"
        description="Select any benefits guide, NDA, compensation plan, or employee handbook to attach to this formal offer."
        actionLabel="Attach to Offer"
      />
    </div>
  );
}
