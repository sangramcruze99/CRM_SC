...
@Module({
  ...
  providers: [WorkflowsService, WorkflowExecutionService, ExecutionPersistenceService],
  exports: [WorkflowsService, WorkflowExecutionService, ExecutionPersistenceService],
})
