...
export const WORKSPACE_ROLES: Record<WorkspaceRole, WorkspaceRoleMetadata> = {
  ...
  finance: {
    ...
    visiblePaths: ['/dashboard', '/invoices', '/quotes', '/subscriptions', '/price-books', '/payment-links', '/qr-payments', '/banking', '/taxes', '/ocr-invoice', '/smart-upload', '/e-signatures', '/ndas', '/offer-letters', '/compliance', '/documents', '/s3-uploads', '/idp', '/data-sync', '/automations', '/automation', '/ai-agents', '/customer-success', '/finance-department'],
  },
  admin: {
    id: 'admin',
