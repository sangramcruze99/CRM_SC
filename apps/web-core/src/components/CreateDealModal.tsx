...
import { Plus, X, Loader2, Briefcase, DollarSign, Layers, Sparkles, Tag } from 'lucide-react';
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="flex items-center gap-2">
                    <h2 className="text-base font-extrabold text-slate-900 dark:text-white tracking-tight">Create Deal Opportunity</h2>
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                    Track revenue potential and stages across your sales funnel
                  </p>
                </div>
              </div>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div className="space-y-1.5">
                <label className="text-[11px] font-bold uppercase tracking-wider text-slate-700 dark:text-slate-300 flex items-center gap-1.5">
                  ...
                  <span>Deal Amount ($ USD)</span>
                </label>
                <div className="relative">
                  <DollarSign size={14} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-emerald-600 dark:text-emerald-400 pointer-events-none" />
                  <input 
                    required 
                    name="amount" 
                    type="number" 
