...
export function CommandPalette() {
  ...
  const commandItems: CommandItem[] = [
    ...
    {
      id: 'nav-automation-os',
      title: 'Developer: AI Automation OS Studio',
      subtitle: 'Unified autonomous business engine, swarm health & telemetry',
      category: 'AI',
    ...
    },
    {
      ...
      title: 'AI Automation OS: Visual Studio & Workflows',
      subtitle: 'DAG pipelines, visual node editor & live canvas',
      category: 'AI',
      icon: <Layers size={16} className="text-emerald-400" />,
      href: '/automation/workflows',
    },
    {
      id: 'nav-automation-agents',
      title: 'AI Automation OS: ReAct Autonomous Agents',
      subtitle: '7 specialist agents swarm (SDR, WhatsApp, Voice, Recruiter)',
      category: 'AI',
      icon: <Bot size={16} className="text-cyan-400" />,
      href: '/automation/agents',
    },
    {
      id: 'nav-automation-approvals',
      title: 'AI Automation OS: Human-in-the-Loop Gate',
      subtitle: 'Safety reviews for high-risk agent decisions & contracts',
      category: 'AI',
      icon: <ShieldCheck size={16} className="text-amber-400" />,
      href: '/automation/approvals',
    },
    {
      id: 'nav-automation-connectors',
    ...
    },
    {
      ...
      title: 'AI Automation OS: Workflow Templates Market',
    ...
    {
      id: 'nav-automation-executions',
      title: 'AI Automation OS: Execution Telemetry & Traces',
      subtitle: 'Live logs, DAG traces & retry management',
      category: 'AI',
