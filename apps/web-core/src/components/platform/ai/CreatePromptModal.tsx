...
import { Plus, X, Sparkles, Bot, Cpu, FileCode } from 'lucide-react';
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="flex items-center gap-2">
                    <h2 className="text-base font-extrabold text-white tracking-tight">Create Prompt Template</h2>
                  ...
                  <p className="text-xs text-slate-400 mt-0.5">
                    Configure parametric system instructions for LLM automation routines
                  </p>
                </div>
              </div>
            ...
            >
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    placeholder="e.g. Sales Outreach Generator" 
                  />
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                <label className="text-[11px] font-bold uppercase tracking-wider text-slate-300 flex items-center gap-1.5">
                  ...
                  <span>Target Model Runtime</span>
                </label>
                <div className="relative">
                  <Cpu size={14} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-400 pointer-events-none" />
                  <select 
                    required 
                    name="model" 
                  ...
                  >
                    <option value="gpt-4o" className="bg-slate-900 text-white">OpenAI GPT-4o (High Speed & Precision)</option>
                    <option value="gpt-4-turbo" className="bg-slate-900 text-white">OpenAI GPT-4 Turbo</option>
                    <option value="claude-3-5-sonnet" className="bg-slate-900 text-white">Anthropic Claude 3.5 Sonnet</option>
                    <option value="claude-3-opus" className="bg-slate-900 text-white">Anthropic Claude 3 Opus</option>
                  </select>
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <textarea 
                  ...
                  name="prompt" 
                  rows={5} 
                  className="w-full p-3 bg-black/40 border border-white/[0.12] rounded-xl text-xs text-white placeholder:text-slate-500 focus:outline-none focus:border-emerald-400 focus:ring-2 focus:ring-emerald-500/20 transition-all font-mono leading-relaxed resize-none" 
                  placeholder="You are an executive assistant. Write a persuasive enterprise proposal to {{contact_name}} about {{deal_name}} with specific terms..."
                />
              </div>
